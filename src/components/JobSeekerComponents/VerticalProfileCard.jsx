...
function VerticalProfileCard({ profileData, isOpenToWork }) {
  return (
        ...
        <div className="flex flex-col items-center text-center  border-b-2 border-gray-200 pb-3">
          <div className="relative group w-20 h-20">
            ...
            {isOpenToWork && (
              <button
                type="button"
                className="absolute  bottom-0 right-0 bg-green-700 text-white text-[10px] p-1 cursor-pointer rounded-full shadow-md border-2 border-white"
              >
          ...
          <p className="text-gray-500 text-sm">
            Experience: {profileData.total_year_exp} Years{" "}
            {profileData.total_month_exp} Months
          </p>
        </div>
        ...
        <div className="flex items-center space-x-2 mb-4">
          <div className="w-6 h-6 bg-red-100 rounded-lg flex items-center justify-center">
            <span className="text-red-600 text-sm">
              <RiMap2Fill size={25} className="text-red-600" />
            </span>
          </div>
          <div>
