...
import { setOpenToWorkRequest } from "./../../../../store/slices/jobSeeker/openToWork/openToWorkSlice";
import {
  getOpenToWorkRequest,
  clearMessages,
} from "./../../../../store/slices/jobSeeker/openToWork/openToWorkSlice";
...
function ProfilePanel() {
  ...
  const openToWorkMsg = useSelector((state) => state.openToWork.message);
  ...
  const handleOpenToWork = () => {
    dispatch(setOpenToWorkRequest(!openToWorkStatus));
  };
        ...
        <div className="flex gap-3 lg:gap-0 flex-col lg:flex-row justify-between items-center border-b pb-4">
          ...
          <div className="flex flex-row gap-1">
            <button
              ...
              onClick={() => navigate("/jobseeker/resume-builder")}
            >
              Resume Builder
            </button>
          ...
          <section className="mt-6">
            ...
            {researchPapers.map((paper, i) => (
              <div key={i} className="mt-3">
                ...
                <p className="text-gray-600">
                  Status: {paper.status}, Published In: {paper.publicationName}
                </p>
              </div>
            ))}
          </section>
